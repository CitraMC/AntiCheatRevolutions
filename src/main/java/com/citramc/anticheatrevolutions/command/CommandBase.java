...
public class CommandBase {
    ...
    public static final Configuration CONFIG = AntiCheatRevolutions.getManager().getConfiguration();
    public static final UserManager USER_MANAGER = AntiCheatRevolutions.getManager().getUserManager();
    public static final CheckManager CHECK_MANAGER = AntiCheatRevolutions.getManager().getCheckManager();
        ...
        if (permission.get(cs)) {
			...
			if (args == null) {
				cs.sendMessage(GOLD + "" + ChatColor.BOLD + "ACR" + ChatColor.DARK_GRAY + " > "
						+ ChatColor.GRAY + "Running " + GOLD + "AntiCheatRevolutions " + GRAY + "version "
						+ GOLD + AntiCheatRevolutions.getVersion());
			} else {
    ...
    public void sendHelp(CommandSender cs) {
        cs.sendMessage(GOLD + "" + ChatColor.BOLD + "AntiCheatRevolutions" + ChatColor.DARK_GRAY + " > " + ChatColor.GRAY + "Help Menu");
