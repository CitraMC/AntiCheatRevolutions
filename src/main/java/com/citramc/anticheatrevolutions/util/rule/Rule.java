 ...
 *   <li>Check
 *     <ul>
 *       <li>Contains all valid checks as listed in {@link com.citramc.anticheatrevolutions.check.CheckType}</li>
 ...
 * The only current Rule implementation is the {@link com.citramc.anticheatrevolutions.util.rule.ConditionalRule}
 */
public class Rule {
