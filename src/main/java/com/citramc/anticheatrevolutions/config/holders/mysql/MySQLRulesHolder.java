...
import com.citramc.anticheatrevolutions.util.rule.Rule;
        ...
        try {
            ...
            while (set.next()) {
                ...
                if (rule != null) {
                    ...
                    AntiCheatRevolutions.getPlugin().getLogger().warning("Couldn't load rule '" + string + "' from the database. Improper format used.");
                }
            }
