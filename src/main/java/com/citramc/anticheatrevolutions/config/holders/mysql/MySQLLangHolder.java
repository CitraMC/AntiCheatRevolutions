...
public class MySQLLangHolder extends ConfigurationTable implements InvocationHandler {
    ...
    @Override
    public void open() {
    	InputStreamReader reader = new InputStreamReader(AntiCheatRevolutions.getPlugin().getResource("lang.yml"));
    ...
    public Object invoke(Object proxy, Method method, Object[] args) {
        ...
        AntiCheatRevolutions.getPlugin().getLogger().severe("The lang value " + key + " couldn't be found.");
