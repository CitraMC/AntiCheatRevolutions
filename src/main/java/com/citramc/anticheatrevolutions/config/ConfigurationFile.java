...
import com.citramc.anticheatrevolutions.config.yaml.CommentedConfiguration;
...
public class ConfigurationFile {
    ...
    private AntiCheatRevolutions plugin;

    private boolean saveDefault;

    protected boolean needsReload;

    public ConfigurationFile(AntiCheatRevolutions plugin, Configuration config, String fileName) {
        this(plugin, config, fileName, true);
    }

    public ConfigurationFile(AntiCheatRevolutions plugin, Configuration config, String fileName, boolean saveDefault) {
        this(plugin, config, fileName, saveDefault, new File(plugin.getDataFolder(), fileName));
    }

    public ConfigurationFile(AntiCheatRevolutions plugin, Configuration config, String fileName, boolean saveDefault, File rawFile) {
