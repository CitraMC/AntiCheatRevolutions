...
package com.citramc.anticheatrevolutions.config.files;
...
import com.citramc.anticheatrevolutions.util.enterprise.Database;
...
public class Enterprise extends ConfigurationFile {
    ...
    public Enterprise(AntiCheatRevolutions plugin, Configuration config) {
